...
class SliderPuzzle : public PuzzleState {
 public:
  // Preconditions: arg1 >= 1, arg2 >=1, arg3 is a permutation of the
  // string "01234..k", where k = arg1*arg2-1 representing the initial
  // board state, where the 0 entry is the blank space in the puzzle.
