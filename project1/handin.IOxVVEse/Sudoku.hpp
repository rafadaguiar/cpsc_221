...
class Sudoku : public PuzzleState {
 public:
  // Precondition: the string is 81 characters long, representing the
  // initial configuration, in row-major order.  Zeroes are for empty
  // squares, and the other digits are for squares already filled in.
  Sudoku(string);
